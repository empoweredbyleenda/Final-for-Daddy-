      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl font-light text-gray-900 mb-4">
            What Our Clients
            <span className="block text-[#E91E8C] font-semibold">Are Saying</span>
          </h2>
          <div className="flex items-center justify-center gap-1 mb-2">
            {[...Array(5)].map((_, i) => (
              <Star key={i} className="text-[#E91E8C] fill-[#E91E8C]" size={24} />
            ))}
          </div>
          <p className="text-gray-600">5.0 Average Rating from 50+ Reviews</p>
        </div>
            ...
            >
              ...
              <div className="flex gap-1 mb-4 mt-2">
                {[...Array(testimonial.rating)].map((_, i) => (
                  <Star key={i} className="text-[#E91E8C] fill-[#E91E8C]" size={16} />
                ))}
              </div>
